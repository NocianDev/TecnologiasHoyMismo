...
function AvailabilityBadge({ mobile = false }: { mobile?: boolean }) {
  return (
...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-[999] overflow-hidden border-b border-white/10 bg-black/75 backdrop-blur-xl">
      ...
      {/* Espacio para que el contenido no quede escondido debajo de la navbar fixed */}
      <div className="h-[73px] sm:h-[82px] lg:h-[88px] xl:h-[92px] 2xl:h-[110px]" />
    </>
  );
}