export default function WhatsAppButton() {
  const phone = "528100000000"; // cambia esto por tu número real
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[999] flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_30px_rgba(37,211,102,0.35)] transition hover:scale-110"
    >
      <svg
